      ...
      <main className="flex-grow px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full relative z-10">
        ...
        <div className="mb-10 sm:mb-14 text-center max-w-3xl mx-auto">
          ...
          <p className="font-body-lg text-sm sm:text-base md:text-lg text-slate-text leading-relaxed">
            Make fast, direct, and zero-surcharge payments for Gourav Dharkar research subscriptions and advisory plans via verified Bank Transfer or UPI QR.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative group mx-auto max-w-[280px] sm:max-w-[320px] bg-[#070707] p-4 rounded-2xl border border-white/10 shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.6),0_10px_30px_rgba(0,0,0,0.8)] overflow-hidden">
                <div className="relative aspect-square w-full rounded-xl overflow-hidden bg-white/5 flex items-center justify-center">
                  <Image
                    src="/payment.jpeg"
                    alt="Gourav Dharkar UCO Bank UPI Payment QR Code"
                    width={400}
                    height={400}
                    priority
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 max-w-md sm:max-w-none mx-auto">
              <a
                href="https://wa.me/919827562967?text=Hi%2C%20I%20have%20made%20a%20payment%20for%20Gourav%20Dharkar%20research%20service.%20Here%20is%20my%20payment%20proof."
                target="_blank"
              ...
              <a
                href="mailto:dharkargourav@gmail.com?subject=Payment%20Confirmation%20-%20Gourav%20Dharkar&body=Hello%20Gourav%20Dharkar%2C%0A%0AI%20have%20transferred%20the%20subscription%20fee.%20Attached%20is%20my%20payment%20receipt.%0A%0AName%3A%0APhone%3A%0AService%20Opted%3A%0AUTR%20%2F%20Transaction%20ID%3A"
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-text">
                Please verify that the beneficiary name displays as <strong className="text-on-surface">GOURAV DHARKAR</strong> and bank is <strong className="text-on-surface">UCO BANK</strong> (A/C: <strong className="text-on-surface">22460210002377</strong>, IFSC: <strong className="text-on-surface">UCBA0002246</strong>). Gourav Dharkar operates strictly under SEBI Research Analyst registration <strong className="text-premium-gold">INH000025300</strong> and never solicits cash deposits or payments to unauthorized accounts.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-white/5 flex items-center justify-between">
                ...
                <a
                  href="/payment.jpeg"
                  download="Gourav_Dharkar_Payment_QR.jpeg"
