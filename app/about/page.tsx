    ...
    <div className="relative w-full pt-[100px] sm:pt-[120px] pb-24">
      ...
      <main className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full relative z-10">
        ...
        <section className="mb-14 sm:mb-20 text-center max-w-4xl mx-auto">
          <h1 className="font-display-lg text-3xl sm:text-5xl md:text-6xl font-normal mb-4 sm:mb-6 font-headline leading-tight tracking-tight">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-16 sm:mb-24">
          {/* Company Story (Spans 8 columns on desktop) */}
          <motion.div
            whileHover={{ y: -3 }}
          ...
          {/* Core Values (Spans 4 columns on desktop) */}
          <motion.div
            whileHover={{ y: -3 }}
            style={{ boxShadow: cardShadow }}
            transition={springTransition}
          ...
          >
            <div className="flex items-center gap-3 mb-5 sm:mb-6">
              ...
              <h2 className="font-headline-lg text-xl sm:text-2xl md:text-3xl font-normal font-headline tracking-tight">Core <span className="italic text-primary">Values</span></h2>
            </div>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <span className="material-symbols-outlined text-primary text-sm mt-1 shrink-0">check_circle</span>
                <div>
                  <h3 className="font-label-md text-sm text-on-surface font-semibold mb-0.5">Integrity</h3>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-label-md text-sm text-on-surface font-semibold mb-0.5">Transparency</h3>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-label-md text-sm text-on-surface font-semibold mb-0.5">Precision</h3>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-label-md text-sm text-on-surface font-semibold mb-0.5">Client-Focus</h3>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-16 sm:mb-24">
          {/* Leadership Message */}
          <motion.div
            whileHover={{ y: -3 }}
            style={{ boxShadow: cardShadow }}
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
                ...
                <h2 className="font-headline-lg text-xl sm:text-2xl md:text-3xl font-normal font-headline text-on-surface tracking-tight">Regulatory <span className="italic text-error">Compliance</span></h2>
              </div>
        ...
        <motion.section 
          ...
          style={{ boxShadow: cardShadow }}
          transition={springTransition}
          className="bg-[#171717] rounded-2xl p-8 sm:p-12 text-center relative overflow-hidden border-t border-white/20 border-x border-white/[0.02] border-b border-white/10"
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="font-headline-lg text-2xl sm:text-3xl md:text-5xl font-normal mb-4 font-headline text-on-surface tracking-tight">
              Join Thousands of <span className="text-primary italic">Successful</span> Investors.
            </h2>
            <p className="text-slate-text mb-8 leading-relaxed text-sm sm:text-base">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3.5 sm:gap-4 max-w-md sm:max-w-none mx-auto">
              <MotionLink
                ...
                className="gradient-bg-primary text-background font-label-md text-sm px-8 py-3.5 rounded-full hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] transition-all font-bold focus-ring cursor-pointer flex items-center justify-center"
              >
                Start Your Journey
              </MotionLink>
              <MotionLink
                ...
                whileTap={{ scale: 0.97 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                className="bg-[#070707] border border-white/10 text-premium-gold font-label-md text-sm px-8 py-3.5 rounded-full hover:bg-white/5 transition-all font-bold focus-ring cursor-pointer shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.6)] flex items-center justify-center"
              >
                View Our Services
              </MotionLink>
            </div>
